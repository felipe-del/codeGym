...
public class StreamIntermediate {
    ...
    /*
     *
     * _______ _______ _______ _______ _________ _ _______ __ _______ _______
     * _______ ____________________________________ _______ _ _________ _ _______
     * ( ____ \( ____ )( ___ )|\ /|( ____ )\__ __/( ( /|( ____ \ /__\ ( ____ )( ___
     * )( ____ )\__ __/\__ __/\__ __/\__ __/( ___ )( ( /|\__ __/( ( /|( ____ \
     * | ( \/| ( )|| ( ) || ) ( || ( )| ) ( | \ ( || ( \/ ( \/ ) | ( )|| ( ) || ( )|
     * ) ( ) ( ) ( ) ( | ( ) || \ ( | ) ( | \ ( || ( \/
     * | | | (____)|| | | || | | || (____)| | | | \ | || | \ / | (____)|| (___) ||
     * (____)| | | | | | | | | | | | || \ | | | | | \ | || |
     ...
     * (___) |
     * (_______)|/ \__/(_______)(_______)|/ \_______/|/ )_)(_______) \___/\/ |/ |/
     * \||/ \__/ )_( \_______/ )_( \_______/(_______)|/ )_)\_______/|/ )_)(_______)
     *
    ...
    public Map<String, Optional<Integer>> maxBySign(List<Integer> numbers) {
        return numbers.stream()
                .collect(Collectors.groupingBy(n -> {
                    if (n > 0)
                        return "Positivo mayor";
                    if (n < 0)
                        return "Negativo mayor";
                    return "Cero";
    ...
    /*
     * _______ _ _______ _________ _______ _______ _______ _ _______ _______
     * _________ _______ ______
     * ( ____ \( \ ( ___ )\__ __/( )( ___ )( ____ ) /\ ( ( /|( ____ \( ____ \\__
     * __/( ____ \( __ \
     * | ( \/| ( | ( ) | ) ( | () () || ( ) || ( )| / / | \ ( || ( \/| ( \/ ) ( | (
     * \/| ( \ )
     * | (__ | | | (___) | | | | || || || (___) || (____)| / / | \ | || (__ | (_____
     * | | | (__ | | ) |
     * | __) | | | ___ | | | | |(_)| || ___ || _____) / / | (\ \) || __) (_____ ) |
     * | | __) | | | |
     * | ( | | | ( ) | | | | | | || ( ) || ( / / | | \ || ( ) | | | | ( | | ) |
     * | ) | (____/\| ) ( | | | | ) ( || ) ( || ) / / | ) \ || (____/\/\____) | | |
     * | (____/\| (__/ )
     ...
     * (_______/(______/
     *
     * FlatMap es una operación que transforma cada elemento en otro stream y luego
     * aplana todos
     * los resultados en un único stream continuo
     *
     * Nested Structures son estructuras de datos que contienen otras estructuras
     * dentro (por ejemplo
    ...
    /*
     * _______ _________ _______ __________________ _______ __________________
     * _______ _______
     ...
     * operación.
     *
     * Se usa normalmente con IntStream.summaryStatistics() o
    ...
    // Obtener lista de números en espejo (negativos -> positivos, positivos ->
    // negativos)
    ...
    public Map<Character, String> longestBYFirstChar(List<String> words) {
        return words.stream()
                .collect(Collectors.groupingBy(
                        w -> w.charAt(0),
                        Collectors.collectingAndThen( // El segundo parámetro recibe una lambda
                                // de finalización
    ...
    public List<String> flattenDistinctWords(List<String> sentences) {
        return sentences.stream()
                .flatMap(s -> Arrays.stream(s.split(" ")))
                .distinct()
                .toList();
    ...
    // Obtener palabra más larga de cada sublista
    public Map<Integer, String> longestWordPerSublist(List<List<String>> nested) {
         return IntStream.range(0, nested.size())
                .boxed()
                .collect(Collectors.toMap(
                        i -> i,
                        i -> nested.get(i).stream()
                                .max(Comparator.comparingInt(String::length))
                                .orElse("")
                ));
    }
    ...
    public Optional<String> mostFrequentString(List<String> words) {
        return words.stream()
    ...
    // Concatenar todas las palabras en mayúsculas con espacio →
    // reduceToUppercaseSentence
    ...
    // Contar total de caracteres de todas las palabras usando map + reduce →
    // reduceTotalChars
    ...
    // Concatenar palabras de longitud par separadas por coma →
    // reduceEvenLengthWords
    ...
    // Concatenar todas las palabras en minúsculas y ordenadas →
    // reduceSortedLowercaseWords
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> nested = List.of(
                List.of("apple", "banana", "cherry", "cherry"),
